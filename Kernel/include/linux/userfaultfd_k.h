...
#define __VM_UFFD_FLAGS (VM_UFFD_MISSING | VM_UFFD_WP | VM_UFFD_MINOR | VM_UFFD_SWAPPING)
...
// extern void handle_usermemsl(struct vm_area_struct * vma, unsigned long reason);
